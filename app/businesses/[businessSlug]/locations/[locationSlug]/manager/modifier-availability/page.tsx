...
import { ManagerModifierAvailabilityPage } from "@/features/manager/components/ManagerModifierAvailabilityPage"
...
export default async function ManagerModifierAvailabilityRoutePage({
  params,
}: {
  ...
  return (
    <ManagerModifierAvailabilityPage
      businessId={business.id}

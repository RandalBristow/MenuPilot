export const PRODUCT_ADMIN_PANEL_PAGE_CLASS =
...
export const PRODUCT_ADMIN_PANEL_HEADER_CLASS =
  "relative shrink-0 space-y-1 border-b p-4 pr-12"

export const PRODUCT_ADMIN_PANEL_BODY_CLASS =
  "no-scrollbar flex-1 space-y-4 overflow-y-auto px-4 py-3 pb-20"

export const PRODUCT_ADMIN_PANEL_FOOTER_CLASS =
